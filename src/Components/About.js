    ...
    return (
        ...
        <Navbar/>
            <div className="photo" style={{ width: "100%", height: "615px", overflow: "hidden", position: "relative", color: "white" }}>
                ...
                <div className="centeredA">WHO WE ARE?</div>
            </div>
            <div className="contan" style={{ margin: "70px 10px", padding: "40px 80px" }}>
                ...
                <br />
                <h2 style={{ textAlign: "center", marginTop: "70px", marginBottom: "30px", fontWeight: "500px" }}>OUR MISSION</h2>
                ...
                <div className="row" style={{ margin: "0" ,marginBottom:"100px"}}>
                    <div className="left" style={{ width: "50%", padding: "10px 100px 10px 70px" }}>
